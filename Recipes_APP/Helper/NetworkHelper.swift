...
class NetworkHelper {
    ...
    static var lastSuggestion: [String]?{
        didSet{
            UserDefaults.standard.set(lastSuggestion, forKey: "lastSuggestion")
        }
    }
    ...
    static func getLastSuggestion() -> [String]? {
        if let lastSuggestion = UserDefaults.standard.stringArray(forKey: "lastSuggestion") {
            NetworkHelper.lastSuggestion = lastSuggestion
        }
        return NetworkHelper.lastSuggestion
    }
    ...
    static func userLogout() {
        ...
        UserDefaults.standard.removeObject(forKey: "lastSuggestion")
        NetworkHelper.lastSuggestion = nil
